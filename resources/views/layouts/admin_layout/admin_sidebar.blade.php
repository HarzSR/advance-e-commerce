        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item @if(Session::get('page') == "view-sections" || Session::get('page') == "view-categories" || Session::get('page') == "add-edit-category" || Session::get('page') == "view-products" || Session::get('page') == "add-edit-product") menu-open @endif">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="{{ url('/admin/view-products') }}" class="nav-link @if(Session::get('page') == "view-products" || Session::get('page') == "add-edit-product") active @endif">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Products</p>
                                </a>
                            </li>
