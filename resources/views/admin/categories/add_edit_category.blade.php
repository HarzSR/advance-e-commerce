                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label>Section</label>
                                    <select class="form-control select2" id="section_-d" name="section_-d" style="width: 100%;">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="categoryUrl" name="categoryUrl" placeholder="Enter Category URL">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="categoryDiscount" name="categoryDiscount" placeholder="Enter Category Discount">
                                </div>
                                <!-- /.form-group -->
                            </div>
                            <!-- /.col -->
